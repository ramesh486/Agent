...
variable "project_tag" {
  ...
  default = {
      definedTags = {
        ...
        "Automation_Tags.Automation_ResourceType" = "vcn_nonprod_hub"}
      freeformTags = {}
  }
}
...
variable "nonprod_nlb_pub_subnet_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "nonprod_nlb_pub_subnet"}
      freeformTags = {}
  }
}
...
variable "nonprod_untrust_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "nonprod_untrust_subnet"}
      freeformTags = {}
  }
}
...
variable "nonprod_management_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "nonprod_management_subnet"}
      freeformTags = {}
  }
}
...
variable "nonprod_trust_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "nonprod_trust_subnet"}
      freeformTags = {}
  }
}
