...
variable "project_tag" {
  ...
  default = {
      definedTags = {
        ...
        "Automation_Tags.Automation_ResourceType" = "load_balancer"
        }
      freeformTags = {}
  }
}
...
variable private_ip_address {
  type = string
  default = "10.97.1.169"
  description = "PaloAlto nonprod_paloalto1 private_ip_address"
}
...
variable backendset_name {
  type = string
  default = "np_int_pvt_nlb_backendset"
