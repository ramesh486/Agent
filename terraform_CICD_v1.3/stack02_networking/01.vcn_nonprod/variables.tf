...
variable "project_tag" {
  ...
  default = {
      definedTags = {
        ...
        "Automation_Tags.Automation_ResourceType" = "vcn_nonprod"}
      freeformTags = {}
  }
}
...
variable "nonprod_vcn_display_name" {
  type        = string
  description = "NonProd VCN Display Name"
  default     = "nonprod_vcn"
}

variable "nonprod_vcn_dns_label" {
  type        = string
...
variable "appdev_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "nonprod-vcn"}
      freeformTags = {}
  }
}
...
variable "nonprod_vcn_servicegateway_private_display_name" {
  type        = string
  description = "NonProd VCN Service Gateway Display Name"
  default     = "nonprod_vcn_servicegateway_private"
}

variable "nonprod_vcn_natgateway_display_name" {
  type        = string
  description = "NonProd VCN NAT Gateway Display Name"
  default     = "nonprod_vcn_natgateway"
}

variable "nonprod_vcn_natgateway_block_traffic" {
  type        = bool
  description = "Block the traffic in NAT gateway on creation"
  default     = false
}

variable "nonprod_vcn_natgateway_public_ip_lifetime" {
  type        = string
  description = "Reserved IP Address will be created for NAT Gateway"
  default     = "RESERVED"
}
variable "nonprod_vcn_intgw_display_name" {
   type        = string
  description = "NonProd VCN Internet Gateway Display Name"
  default = "nonprod_vcn_intgw"
}

variable "nonprod_vcn_intgw_enabled" {
  type        = bool
  description = "Is Nonprod  intgw enabled"
  default = true
}
...
variable "nonprod_vcn_routetable_private_appdev_display_name" {
  type = string
  description = "NonProd VCN AppDev Route Table"
  default = "nonprod_vcn_routetable_private_appdev"
}

variable "nonprod_vcn_routetable_private_dbdev_display_name" {
  type = string
  description = "NonProd VCN DBDev Route Table"
  default = "nonprod_vcn_routetable_private_dbdev"
}

variable "nonprod_vcn_routetable_private_apptst_display_name" {
  type = string
  description = "NonProd VCN AppTst Route Table"
  default = "nonprod_vcn_routetable_private_apptst"
}

variable "nonprod_vcn_routetable_private_dbtst_display_name" {
  type = string
  description = "NonProd VCN DBTst Route Table"
  default = "nonprod_vcn_routetable_private_dbtst"
}
...
variable "nonprod_vcn_drg_attachment_display_name" {
  type = string
  description = "DRG Attachment Display Name"
  default = "nonprod_vcn_drg_attachment"
}
...
variable "nonprod_vcn_seclist_private_display_name" {
  type = string
  description = "NonProd VCN Private Security List Display Name"
  default = "nonprod_vcn_seclist_private"
}

variable "nonprod_vcn_seclist_private_is_stateless" {
  type = bool
  description = "NonProd VCN Private Security List is Stateless?"
  default = false
}
