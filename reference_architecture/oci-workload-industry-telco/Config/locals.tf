...
locals {
  ...
  operator_key_private = tls_private_key.rsa_2048.private_key_pem
  operator_key_public  = tls_private_key.rsa_2048.public_key_openssh
}
...
# Store private and public keys in locals
