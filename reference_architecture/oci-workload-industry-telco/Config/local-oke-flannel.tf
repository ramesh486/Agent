...
resource "local_file" "private_key_file" {
  content  = local.operator_key_private
...
workers_configuration_flannel = {
  node_pools = merge(
  {
    NODEPOOL1 = {
      ...
      node_config_details = {
        ssh_public_key_path = local.operator_key_public
...
instances_configuration = {
  ...
  default_ssh_public_key_path = local.operator_key_public
  instances = {
    INSTANCE-1 = {
      ...
      image = {
        id = data.oci_core_images.images.images.0.id # "Oracle-Linux-Cloud-Developer-8.7-2023.04.28-1" Platform image
      }
      encryption = {
...
sessions_configuration = {
  default_ssh_public_key = local.operator_key_public
  sessions = {
    SESSION-1 = {
