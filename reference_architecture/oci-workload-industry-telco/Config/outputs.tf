...
output "operator_key_private" {
  value = local.operator_key_private
  sensitive = true
}

# Output the public key
output "operator_key_public" {
  value = local.operator_key_public
  sensitive = true
}

output "workers_configuration_flannel" {
    value = local.workers_configuration_flannel
}