...
#   log_group_id          = local.prod_archive_default_log_service_connector.log_group_id
...
#   log_group_id          = local.nonprod_archive_default_log_service_connector.log_group_id
