...
variable "domain_state" {
  type        = string
  description = "The state of the identity domain (ACTIVE, INACTIVE, etc.)"
}

variable "domain_type" {
  type        = string
  description = "The type of identity domain"
}
...
variable "domain_home_region_url" {
  type        = string
  description = "The home region URL of the identity domain"
}
