...
variable "compartment_ocid" {
    default = "ocid1.compartment.oc1..aaaaaaaady4viyseb4lpgxknokreorj22zkrzhg25pxvgcax5jhymar7t2ha"
}
variable "region" {
...
variable "subnet_ocid" {
  default = "ocid1.subnet.oc1.us-sanjose-1.aaaaaaaa7w4vapbrglqys7ssavkk3swwzkgw7bpa4hyjh33vpc2kenyffb7a"
}
