...
variable "subnet_ocid" {
    type        = string
    default     = ""
    description = "Subnet ID in Subtree"
}
...
#     type        = string
#     default     = ""
#     description = "enter the availability domain"
# }
...
variable "source_id" {
  ...
  default     = "ocid1.image.oc1..aaaaaaaafw745srawcq6wdqifnsx4z2q3jrc74taxechflcv3ttrtmzsmlca"
