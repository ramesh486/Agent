module "oke_cluster" {
    ...
    instance_vm_image_ocid                                  = var.instance_vm_image_ocid
    ...
    load_balancer_subnet_ocid                               = var.load_balancer_subnet_ocid
    use_custom_ssh_public_key                               = var.use_custom_ssh_public_key
    ssh_public_key                                          = var.ssh_public_key
    worker_node_subnet_ocid                                 = var.worker_node_subnet_ocid
    k8s_api_endpoint_subnet                                 = var.k8s_api_endpoint_subnet
