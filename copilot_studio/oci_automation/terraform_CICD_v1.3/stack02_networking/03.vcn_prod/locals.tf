locals {
  ...
  prod_vcn_routetable_private = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.prod_vcn_natgateway.natgateway_ocid
    ...
    },
    {
      ...
      "network_entity_id" = module.prod_vcn_servicegateway_private.service_gateway_ocid
      "destination_type"  = "SERVICE_CIDR_BLOCK"
    }
  ]
  
  prod_vcn_routetable_private_appdev_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.prod_vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  prod_vcn_routetable_private_dbdev_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.prod_vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  prod_vcn_routetable_private_apptst_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.prod_vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  prod_vcn_routetable_private_dbtst_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.prod_vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  prod_vcn_seclist_private_destination_security_rules = [
    {
      ...
      "security_list_egress_security_rules_stateless"         = var.prod_vcn_seclist_private_is_stateless 
    }
  ]
  prod_vcn_seclist_private_source_security_rules = [
    {
      ...
      "security_list_ingress_security_rules_stateless"        = var.prod_vcn_seclist_private_is_stateless 
    },
    {
      "security_list_ingress_security_rules_source"           = var.prod_hub_vcn_cidr_block
      "security_list_ingress_security_rules_protocol"         = local.security_list_protocols.ALL_PROTOCOLS
      "security_list_ingress_security_rules_source_type"      = local.cidr_blocks_type.cidr_block
      "security_list_ingress_security_rules_stateless"        = var.prod_vcn_seclist_private_is_stateless 
    },
