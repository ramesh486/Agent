...
variable "project_tag" {
  ...
  default = {
      definedTags = {
        ...
        "Automation_Tags.Automation_ResourceType" = "WAF SSl Certificate"
        }
      freeformTags = {}
  }
}
...
variable "certificate_display_name" {
  ...
  description  = "Display name for the SSL certificate."
}
...
variable "certificate_is_trust_verification_disabled" {
  type         = bool
  default      = "true"
  description  = "Set to true if the SSL certificate is self-signed."
}
