...
module "export_oci_objectstorage_alarm" { 
  ...
  alarm_metric_compartment_id               = local.gen_compartment_compartment_ocid
  alarm_metric_compartment_id_in_subtree    = var.compartment_id_in_subtree_gen_compartment
