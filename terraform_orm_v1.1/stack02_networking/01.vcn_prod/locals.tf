locals {
  ...
  vcn_routetable_private = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.vcn_natgateway.natgateway_ocid
    ...
    # },
    {
      ...
      "network_entity_id" = module.vcn_servicegateway_private.service_gateway_ocid
      "destination_type"  = "SERVICE_CIDR_BLOCK"
    }
  ]
  
  vcn_routetable_private_appdev_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  vcn_routetable_private_dbdev_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  vcn_routetable_private_apptst_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  vcn_routetable_private_dbtst_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  vcn_seclist_private_destination_security_rules = [
    {
      ...
      "security_list_egress_security_rules_stateless"         = var.vcn_seclist_private_is_stateless 
    }
  ]
  vcn_seclist_private_source_security_rules = [
    {
      "security_list_ingress_security_rules_source"           = var.vcn_cidr_block
      ...
      "security_list_ingress_security_rules_stateless"        = var.vcn_seclist_private_is_stateless 
    },
    {
      "security_list_ingress_security_rules_source"           = var.hub_vcn_cidr_block
      "security_list_ingress_security_rules_protocol"         = local.security_list_protocols.ALL_PROTOCOLS
      "security_list_ingress_security_rules_source_type"      = local.cidr_blocks_type.cidr_block
      "security_list_ingress_security_rules_stateless"        = var.vcn_seclist_private_is_stateless 
    },
