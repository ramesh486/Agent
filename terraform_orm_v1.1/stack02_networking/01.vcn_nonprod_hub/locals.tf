locals {
  ...
  nonprod_hub_vcn_routetable_private = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.nonprod_hub_vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
    },
    {
      "destination"       = local.cidr_blocks.all_iad_services_in_oracle_services_network
      "network_entity_id" = module.nonprod_hub_vcn_servicegateway_private.service_gateway_ocid
  ...
  nonprod_hub_vcn_routetable_private_untrust_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.nonprod_hub_vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  nonprod_hub_vcn_routetable_private_management_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.nonprod_hub_vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  nonprod_hub_vcn_routetable_private_trust_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.nonprod_hub_vcn_natgateway.natgateway_ocid
      "destination_type"  = "CIDR_BLOCK"
  ...
  nonprod_hub_vcn_routetable_public_nlb_route_rules = [
    {
      "destination"       = "0.0.0.0/0"
      "network_entity_id" = module.nonprod_hub_vcn_intgw.internet_gateway_ocid
      "destination_type"  = "CIDR_BLOCK"
    },
    {
      "destination"       = "10.97.4.0/22"
  ...
  nonprod_hub_vcn_seclist_private_destination_security_rules = [
    {
      ...
      "security_list_egress_security_rules_stateless"         = var.nonprod_hub_vcn_seclist_private_is_stateless 
    }
  ]
   

  nonprod_hub_vcn_seclist_private_source_security_rules = [
   
    {
      ...
      "security_list_ingress_security_rules_stateless"        = var.nonprod_hub_vcn_seclist_private_is_stateless 
    },
    {
...
nonprod_hub_vcn_seclist_public_nlb_destination_security_rules = [
    {
      ...
      "security_list_egress_security_rules_destination_type"   = local.cidr_blocks_type.cidr_block
      "security_list_egress_security_rules_stateless"          = var.nonprod_hub_vcn_seclist_public_nlb_is_stateless 
      "security_list_egress_security_rules_port"               = "22"
}
]
nonprod_hub_vcn_seclist_public_nlb_source_security_rules = [
        {
      "security_list_ingress_security_rules_source"           = "129.159.32.215/32"
      "security_list_ingress_security_rules_protocol"         = local.security_list_protocols.TCP
      "security_list_ingress_security_rules_source_type"      = local.cidr_blocks_type.cidr_block
      "security_list_ingress_security_rules_stateless"        = var.nonprod_hub_vcn_seclist_public_nlb_is_stateless 
       "security_list_ingress_security_rules_port"             = "22"
    }
]
}
