...
variable "project_tag" {
  ...
  default = {
      definedTags = {
        ...
        "Automation_Tags.Automation_ResourceType" = "Prod VCN"
        }
      freeformTags = {}
  }
}
...
variable "prod_nlb_pub_subnet_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "prod_nlb_pub_subnet"
        }
      freeformTags = {}
  }
}
...
variable "prod_untrust_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "prod_untrust_subnet"
        }
      freeformTags = {}
  }
}
...
variable "prod_management_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "prod_management_subnet"
        }
      freeformTags = {}
  }
}
...
variable "prod_trust_project_tag" {
  ...
  default = {
      definedTags = {
        "Automation_Tags.Automation_CostCenter" = "Automation",
        "Automation_Tags.Automation_ResourceType" = "prod_trust_subnet"
        }
      freeformTags = {}
  }
}
