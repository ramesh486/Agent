...
variable "project_tag" {
  ...
  default = {
      definedTags = {
        ...
        "Automation_Tags.Automation_ResourceType" = "Goldengate_connection"
        }
      freeformTags = {}
  }
}
...
variable "connection_description" {
  type = string
  default = "Golden Gate Connection"
}
...
variable "attach_golden_gate_deployment_ocid" {
    type = string
    default = "ocid1.goldengatedeployment.oc1"
    description = "Provide the Golden Gate Deployment OCID which will be attached to this Golden Gate Connection"
}