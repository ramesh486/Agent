...
variable "project_tag" {
  ...
  default = {
      definedTags = {
        ...
        "Automation_Tags.Automation_ResourceType" = "Groups"
        }
      freeformTags = {}
  }
}
...
"Allow group 'default'/'AppAdmins' to use instance-family in compartment oci_nonprod:oci_nonprod_app",
"Allow group 'default'/'AppAdmins' to use volume-family in compartment oci_nonprod:oci_nonprod_app",
"Allow group 'default'/'AppAdmins' to use object-family in compartment oci_nonprod:oci_nonprod_app",
"Allow group 'default'/'AppAdmins' to read virtual-network-family in compartment oci_network",
"Allow group 'default'/'AppAdmins' to use subnets in compartment oci_network",
"Allow group 'default'/'AppAdmins' to use network-security-groups in compartment oci_network",
"Allow group 'default'/'AppAdmins' to use vnics in compartment oci_network",
"Allow group 'default'/'AppAdmins' to use load-balancers in compartment oci_network",
"Allow group 'default'/'AppAdmins' to read vaults in compartment oci_security",
"Allow group 'default'/'AppAdmins' to inspect keys in compartment oci_security",
  ]
...
"Allow group 'default'/'DatabaseAdmins' to read virtual-network-family in compartment oci_network",
"Allow group 'default'/'DatabaseAdmins' to use vnics in compartment oci_network",
"Allow group 'default'/'DatabaseAdmins' to use subnets in compartment oci_network",
"Allow group 'default'/'DatabaseAdmins' to use network-security-groups in compartment oci_network", 
"Allow group 'default'/'DatabaseAdmins' to read vaults in compartment oci_security",
"Allow group 'default'/'DatabaseAdmins' to inspect keys in compartment oci_security",
"Allow group 'default'/'DatabaseAdmins' to use bastion in compartment oci_security",
"Allow group 'default'/'DatabaseAdmins' to manage bastion-session in compartment oci_security",
...
"Allow group 'default'/'DatabaseAdmins' to read all-resources in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage database-family in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage autonomous-database-family in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage alarms in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage metrics in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage object-family in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage orm-stacks in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage orm-jobs in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage orm-config-source-providers in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to read vss-family in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to read work-requests in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to manage bastion-session in compartment oci_nonprod:oci_nonprod_db",
"Allow group 'default'/'DatabaseAdmins' to read instance-agent-plugins in compartment oci_nonprod:oci_nonprod_db",
  ]
...
variable "NetworkAdmins_policy_statements" {
  type = list
  default = [
"Allow group 'default'/'NetworkAdmins' to read all-resources in compartment oci_network",  
"Allow group 'default'/'NetworkAdmins' to manage virtual-network-family in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage dns in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage load-balancers in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage alarms in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage metrics in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage orm-stacks in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage orm-jobs in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage orm-config-source-providers in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to read audit-events in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to read vss-family in compartment oci_security",
"Allow group 'default'/'NetworkAdmins' to read work-requests in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to use bastion in compartment oci_security",
"Allow group 'default'/'NetworkAdmins' to manage bastion-session in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage bastion-session in compartment oci_security",
"Allow group 'default'/'NetworkAdmins' to manage cloudevents-rules in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to manage instance-family in compartment oci_network",
"Allow group 'default'/'NetworkAdmins' to read instance-agent-plugins in compartment oci_network",
...
"Allow group 'default'/'SecurityAdmins' to read all-resources in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage instance-family in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage vaults in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage keys in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage secret-family in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage logging-family in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage serviceconnectors in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage streams in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage ons-family in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage functions-family in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage waas-family in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage security-zone in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to read virtual-network-family in compartment oci_network",
"Allow group 'default'/'SecurityAdmins' to use subnets in compartment oci_network",
"Allow group 'default'/'SecurityAdmins' to use network-security-groups in compartment oci_network",
"Allow group 'default'/'SecurityAdmins' to use vnics in compartment oci_network",
"Allow group 'default'/'SecurityAdmins' to manage orm-stacks in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage orm-jobs in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage orm-config-source-providers in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage vss-family in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to read work-requests in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage bastion-family in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage cloudevents-rules in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage alarms in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to manage metrics in compartment oci_security",
"Allow group 'default'/'SecurityAdmins' to read instance-agent-plugins in compartment oci_security",
